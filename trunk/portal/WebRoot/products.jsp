	...
	<div id="page-inner">
		...
		<div class="productNavbar" id="productNav">
			...
			<% for(Map.Entry<Integer, String> entry : producttypeMap.entrySet()) {%>
				<li>
					<a href="<%=basePath %>products.action?currenttypeID=<%=entry.getKey() %>"><i class="fa fa-circle-o"></i><%=entry.getValue() %></a>
				</li>
					<%	
					}
				    %>
			...
			<div class="col-lg-4">
				<div class="panel panel-default">
			       ...
			       <div class="panel-body">
					    ...
					    <a href="<%=basePath%>openProduct.action?currentproductID=<%=pd.getProductid() %>" class="btn btn-default"><span class="fa fa-eye"></span>&nbsp;查看该产品</a>
						</div>
					</div>
				</div>
			</div>
