...
public class UploadFile {
	...
	public static String upload(HttpServletRequest request, HttpServletResponse response) throws IOException {  
		...
		// 上传文件的保存位置在“/Datum/temp”,该位置在tomcat服务器的“webapps”之中
        String path= ServletActionContext.getServletContext().getRealPath("/Datum/temp");
        String relativePath = "/Datum/temp";
