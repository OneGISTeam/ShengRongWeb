					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-12">
										<form method="post" role="form" action="<%=basePath %>homepage/">
											<div class="form-group">
												<label>新闻标题</label>
												<input datatype="*1-16" errormsg="请不要超过16个字！" class="form-control" name=""/>
												<p class="help-block">请输入新闻标题，不要超过16个字...</p>
											</div>
											<div class="form-group">
												<label>新闻时间</label>											
												<input datatype="*" errormsg="您还没有选择新闻时间！" id="input_date" name="" type='text' class="form-control" />  
											...
											<div class="form-group">
												...
												<input name="" id="input_keywordsdata" datatype="*1-16" errormsg="请设置至少一个关键词，但不要超过128个字！" class="sr-only"/>
											</div>
											<div class="form-group">
												<label>是否发布成头条</label>
	                                            <div class="checkbox">
	                                                <label>
	                                                    <input name="" type="checkbox" value="">发布成头条（如果勾选则发布成头条，较新发布的头条会在公司首页显示）
	                                                </label>
	                                            </div>
											</div>
											<div id="form_group_img" class="form-group">
												...
												<input datatype="*" errormsg="请添加一张图片" name="" type="text" class="sr-only" id="input_imagedata"/>
