					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-12">
										<form method="post" role="form" action="<%=basePath%>recruit/saveRecruit.action">
											<div class="form-group">
	                        					<label>招聘岗位</label>
	                        					<input type="text" class="form-control" datatype="*1-32" errormsg="招聘岗位不能为空，且不要超过32个字！" name="recruit.recruitname"/>
	                        					<p class="help-block">请输入招聘的岗位名称，如销售经理，请不要超过32个字</p>
	                        				</div>
	                        				<div class="form-group">
	                        					<label>年龄要求</label>
	                        					<input type="text" class="form-control" datatype="*1-16" errormsg="招聘年龄不能为空，且不要超过16个字！" name="recruit.age"/>
	                        					<p class="help-block">请输入招聘的年龄要求，如30岁以下，请不要超过16个字</p>
	                        				</div>
	                        				<div class="form-group">
	                        					<label>工作地点</label>
	                        					<input type="text" class="form-control" datatype="*1-16" errormsg="工作地点不能为空，且不要超过16个字！" name="recruit.workplace"/>
	                        					<p class="help-block">请输入该岗位的常年工作地点，如郑州，请不要超过16个字</p>
	                        				</div>
	                        				<div class="form-group">
	                        					<label>薪资报酬</label>
	                        					<input type="text" class="form-control" datatype="*1-16" errormsg="薪资报酬不能为空，且不要超过16个字！" name="recruit.payment"/>
	                        					<p class="help-block">请输入该岗位的薪资报酬，如1W、见面详谈等，请不要超过16个字</p>
	                        				</div>
	                        				<div class="form-group">
	                        					<label>招聘人数</label>
	                        					<input type="text" class="form-control" datatype="*1-16" errormsg="招聘人数不能为空，且不要超过16个字！" name="recruit.recruitnumber"/>
	                        					<p class="help-block">请输入该岗位需要招聘的人数，如3人、不限等，请不要超过16个字</p>
	                        				</div>
	                        				<div class="form-group">
												<label>截止日期</label>											
												<input datatype="*" errormsg="您还没有选择时间！" id="input_deadline" name="recruit.deadline" type='text' class="form-control" />  
									            <p class="help-block">请选择该招聘的截止日期</p>
											</div>
											<div class="form-group">
												<label>岗位职责</label>											
												<script id="ueditor_duty" type="text/plain"></script>
												<input name="recruit.duty" id="input_duty" datatype="*" class="sr-only"/>
									            <p class="help-block">请对该岗位的职责进行简要阐述</p>
											</div>
											<div class="form-group">
												<label>任职要求</label>											
												<script id="ueditor_requirement" type="text/plain"></script>
												<input name="recruit.requirement" id="input_requirement" datatype="*" class="sr-only"/>
